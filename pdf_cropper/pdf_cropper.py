...
# TODO: Allow user to enter path of where outputs should be, if they do not want to use the default one.
file_directory = Path("E:\Desktop\Calculus Transcendentals 8E.pdf") # Creates path to desired pdf
...
if file_directory.exists():
    ...
    ending_point = int(input("Please put in the indes you want to end the cropping at"))
